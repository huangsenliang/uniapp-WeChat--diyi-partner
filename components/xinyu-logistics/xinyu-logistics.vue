			...
			<view>
				<view class="flex list">
					...
					<view class="info flex1">
						...
						<view class="title address">
							<view class="">
								发件地址：{{wlInfo.sendWorkingAddress}}
							</view>
							<view class="">
								发件人：{{wlInfo.sendWorkingRelName }}
							</view>
							<view class="">
								电话：{{wlInfo.sendWorkingRelPhone}}
							</view>
						</view>
					</view>
				</view>
				<view class="flex list"  v-for="(item, index) in wlInfo.list"
				 :key="index">
					<view class="time">
						<view class="day">{{item.AcceptTime.split(" ")[0]}}</view>
						<view style="text-align: center;">{{item.AcceptTime.split(" ")[1]}}</view>
					</view>
					<view class="info flex1">
